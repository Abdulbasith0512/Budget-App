    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        <Animated.View style={[styles.menuContainer, { opacity: fadeAnim }]}>
          <MenuItem icon="person-outline" text="Edit Profile" onPress={() => navigation.navigate("EditProfile")} />
          <MenuItem icon="shield-checkmark-outline" text="Security" onPress={() => Alert.alert("Info", "Security settings coming soon!")} />
          <MenuItem icon="settings-outline" text="Settings" onPress={() => Alert.alert("Info", "Settings coming soon!")} />
          <MenuItem icon="help-circle-outline" text="Help" onPress={() => Alert.alert("Info", "Help section coming soon!")} />
...
const MenuItem = ({ icon, text, onPress }) => (
    <TouchableOpacity style={styles.menuItem} onPress={onPress}>
        <Ionicons name={icon} size={isTablet ? wp('5%') : wp('6%')} color="#6EE7B7" />
